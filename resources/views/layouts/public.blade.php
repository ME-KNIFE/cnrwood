...
<body class="bg-cream font-sans antialiased">
    ...
    <a href="https://wa.me/905350100993"
       ...
       class="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-lg transition-transform hover:scale-110 hover:shadow-xl">
